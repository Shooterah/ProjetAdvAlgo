...
# Create a file graphique
def createFile_graphique(path,wMax, vMax, n, filename) :
...
def mainGraphique(path,filename,n,wMax):
    ...
    wMax = int(wMax)
    vMax = n * MULTV
    createFile_graphique(path,wMax, vMax, n, str(filename))
